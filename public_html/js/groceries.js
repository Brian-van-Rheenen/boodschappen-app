...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_listGroupItemTrash__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_listGroupItemTrash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_listGroupItemTrash__);
...
window.app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: {
        ...
        Listgroupitemtrash: __WEBPACK_IMPORTED_MODULE_2__components_listGroupItemTrash___default.a
    },
    data: {
        groceries: groceries,
        description: '',
        ...
        addItem: function addItem(e) {
            ...
            axios.post(e.target.action, this.$data).then(function (res) {
                ...
                for (var i in _this.groceries) {
                    ...
                    if (_this.groceries[i].description == res.data.description) {
                ...
                if (found) {
                    //Update the quantity
                    _this.groceries[index].quantity = res.data.quantity;
        ...
        getItems: function getItems() {
            ...
            if (this.description.length > 0) {
                ...
                this.timer = window.setTimeout(function () {
                    ...
                    axios.get('/boodschappen/popular/' + this.description).then(function (res) {
                        ...
                        for (var i in response) {
                            ...
                            _this3.popularItems.push(response[i]);
                        }

                        //Set maximum shown items
                        _this3.popularItems.splice(5, response.length);
                    });
                ...
                this.timer = window.setTimeout(function () {
                    ...
                    //Get all the popular items
                    axios.get('/boodschappen/popular').then(function (res) {
                        ...
                        for (var i in response) {
                            //Push all the items inside the array
                            _this4.popularItems.push(response[i]);
                        }

                        //Set maximum shown items
                        _this4.popularItems.splice(5, response.length);
                    });
                }.bind(this), 500);
            }
        },
    ...
    methods: {
        loadData: function loadData() {
            ...
            $.get('/boodschappen/all', function (response) {
                ...
                this.completedGroceries = response.filter(function (item) {
                    return item.completed;
                });
                this.incompletedGroceries = response.filter(function (item) {
                    return !item.completed;
                });
            }.bind(this));
        },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "emptyTrash" }, [
      _c("span", [_vm._v("Geen producten gevonden")]),
      _vm._v(" "),
...
Component.options.__file = "resources/assets/js/components/listGroupItemTrash.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-40f34fec", Component.options)
  } else {
    hotAPI.reload("data-v-40f34fec", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        trash: function trash(item) {
            //Find the index of this grocery item
            var index = this.groceries.findIndex(function (x) {
                return x.id == item.id;
            });
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "trashInnerContainer" },
    [
      _vm.completedGroceries.length || _vm.incompletedGroceries.length
        ? [
            _vm.incompletedGroceries.length
              ? _vm._l(_vm.incompletedGroceries, function(item) {
                  return _c(
                    ...
                    [
                      _c(
                        "span",
                        {
                          staticClass: "hoeveelheid trash-left",
                          class: { checked: item.completed }
                        },
                        [_vm._v(_vm._s(item.quantity) + "x")]
                      ),
                      ...
                      _vm._v(" "),
                      _c("i", {
                        staticClass: "fa fa-trash-o trash-right",
                        on: {
                          click: function($event) {
                            _vm.trash(item)
                          }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-40f34fec", module.exports)
  }
}
